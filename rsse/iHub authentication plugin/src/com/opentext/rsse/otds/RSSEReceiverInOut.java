...
/**
 * RSSEReceiverInOut message receiver
 */

public class RSSEReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
	
	private static final Logger LOGGER = Logger.getLogger(RSSEReceiverInOut.class.getName());

	public void invokeBusinessLogic(org.apache.axis2.context.MessageContext msgContext,
			org.apache.axis2.context.MessageContext newMsgContext) throws org.apache.axis2.AxisFault {

		LOGGER.info("invokeBusinessLogic");
		try {
...
//			}
			...
			RSSEInterface skel = (RSSEInterface) obj;
			// Out Envelop
			...
			if ((op.getName() != null)
				...
				if ("getTranslatedUserNames".equals(methodName)) {
					LOGGER.info("getTranslatedUserNames");
				...
				if ("getConnectionProperties".equals(methodName)) {
					LOGGER.info("getConnectionProperties");
				...
				if ("getTranslatedRoleNames".equals(methodName)) {
					LOGGER.info("getTranslatedRoleNames");
