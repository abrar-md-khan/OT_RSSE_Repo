                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArrayOfString".equals(type)){
                                ...
                                return (ArrayOfString)com.actuate.schemas.actuate11.rsse.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.actuate.com/actuate11/rsse","String").equals(reader.getName()) || new javax.xml.namespace.QName("","String").equals(reader.getName()) ){
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://schemas.actuate.com/actuate11/rsse","String").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
