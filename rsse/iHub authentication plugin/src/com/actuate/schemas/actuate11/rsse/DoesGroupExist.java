 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DoesGroupExist",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DoesGroupExist",
    ...
    public static class Factory{
        ...
        */
        public static DoesGroupExist parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DoesGroupExist object =
                new DoesGroupExist();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DoesGroupExist".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DoesGroupExist)com.actuate.schemas.actuate11.rsse.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
